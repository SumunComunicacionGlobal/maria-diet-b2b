...
/*!
	  ...
	  * Licensed under MIT (https://github.com/twbs/bootstrap/blob/main/LICENSE)
	  */
!function(e,t){e.exports=function(e,t,i,n){const s=e=>e&&"object"==typeof e&&"default"in e?e:{default:e},o=s(t),r=s(i),a="toast",l=".bs.toast",c=`mouseover${l}`,u=`mouseout${l}`,d=`focusin${l}`,f=`focusout${l}`,h=`hide${l}`,p=`hidden${l}`,g=`show${l}`,m=`shown${l}`,_="fade",b="hide",v="show",y="showing",w={animation:"boolean",autohide:"boolean",delay:"number"},x={animation:!0,autohide:!0,delay:5e3};class T extends r.default{constructor(e,t){super(e,t),this._timeout=null,this._hasMouseInteraction=!1,this._hasKeyboardInteraction=!1,this._setListeners()}static get Default(){return x}static get DefaultType(){return w}static get NAME(){return a}show(){if(o.default.trigger(this._element,g).defaultPrevented)return;this._clearTimeout(),this._config.animation&&this._element.classList.add(_);const t=()=>{this._element.classList.remove(y),o.default.trigger(this._element,m),this._maybeScheduleHide()};this._element.classList.remove(b),e.reflow(this._element),this._element.classList.add(v,y),this._queueCallback(t,this._element,this._config.animation)}hide(){if(!this.isShown())return;if(o.default.trigger(this._element,h).defaultPrevented)return;const e=()=>{this._element.classList.add(b),this._element.classList.remove(y,v),o.default.trigger(this._element,p)};this._element.classList.add(y),this._queueCallback(e,this._element,this._config.animation)}dispose(){this._clearTimeout(),this.isShown()&&this._element.classList.remove(v),super.dispose()}isShown(){return this._element.classList.contains(v)}_maybeScheduleHide(){this._config.autohide&&(this._hasMouseInteraction||this._hasKeyboardInteraction||(this._timeout=setTimeout((()=>{this.hide()}),this._config.delay)))}_onInteraction(e,t){switch(e.type){case"mouseover":case"mouseout":this._hasMouseInteraction=t;break;case"focusin":case"focusout":this._hasKeyboardInteraction=t}if(t)return void this._clearTimeout();const i=e.relatedTarget;this._element===i||this._element.contains(i)||this._maybeScheduleHide()}_setListeners(){o.default.on(this._element,c,(e=>this._onInteraction(e,!0))),o.default.on(this._element,u,(e=>this._onInteraction(e,!1))),o.default.on(this._element,d,(e=>this._onInteraction(e,!0))),o.default.on(this._element,f,(e=>this._onInteraction(e,!1)))}_clearTimeout(){clearTimeout(this._timeout),this._timeout=null}static jQueryInterface(e){return this.each((function(){const t=T.getOrCreateInstance(this,e);if("string"==typeof e){if(void 0===t[e])throw new TypeError(`No method named "${e}"`);t[e](this)}}))}}return n.enableDismissTrigger(T),e.defineJQueryPlugin(T),T}(r(),c(),w(),A())}(Vt);var Kt,Xt,Yt,Ut=Vt.exports;Kt=navigator.userAgent.toLowerCase().indexOf("webkit")>-1,Xt=navigator.userAgent.toLowerCase().indexOf("opera")>-1,Yt=navigator.userAgent.toLowerCase().indexOf("msie")>-1,(Kt||Xt||Yt)&&document.getElementById&&window.addEventListener&&window.addEventListener("hashchange",(function(){var e,t=location.hash.substring(1);/^[A-z0-9_-]+$/.test(t)&&(e=document.getElementById(t))&&(/^(?:a|select|input|button|textarea)$/i.test(e.tagName)||(e.tabIndex=-1),e.focus())}),!1),jQuery(document).ready((function(e){e((function(){e('[data-bs-toggle="popover"]').popover().click((function(e){}))})),e(".shop-menu-item > .nav-link").click((function(t){t.preventDefault(),e("#offcanvasShop").offcanvas("show")})),e("#offcanvasShop .cat-parent > a").click((function(t){t.preventDefault(),e(this).next(".children").slideToggle()})),e("#offcanvasShop .cat-parent > a").each((function(){var t=e(this).attr("href");e(this).next(".children").prepend('<li class="cat-item cat-item-all"><a href="'+t+'">Ver todo</a></li>')}));var t=e("body");e("#main-nav").attr("class"),jQuery(window).scroll((function(){e(window).scrollTop()>=25?t.addClass("scrolled"):t.removeClass("scrolled"),e(window).scrollTop()+e(window).height()>e(document).height()-100?t.addClass("near-bottom"):t.removeClass("near-bottom")})),e("#navbarNavDropdown").on("show.bs.collapse",(function(){t.addClass("menu-open")})),e("#navbarNavOffcanvas").on("show.bs.offcanvas",(function(){t.addClass("menu-open")})),e("#navbarNavDropdown").on("hide.bs.collapse",(function(){t.removeClass("menu-open")})),e("#navbarNavOffcanvas").on("hide.bs.offcanvas",(function(){t.removeClass("menu-open")})),e(".alert-go-to-my-account button.btn-close").click((()=>{document.cookie="account_notice_shown=true; path=/; max-age=2592000"})),e(".alert-welcome button.btn-close").click((()=>{document.cookie="alert_welcome_shown=true; path=/; max-age=604800"})),e(".nav-link").on("shown.bs.tab",(function(t){var i=e(this).attr("href"),n=e("#wrapper-navbar").height();e("html, body").animate({scrollTop:e(i).offset().top-n},"fast")}))}));const Jt='<button class="slick-prev slick-prev-custom" arial-label="Previous" type="button"><svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M20 40C8.9543 40 -2.7141e-06 31.0457 -1.74846e-06 20C-7.8281e-07 8.9543 8.95431 -2.7141e-06 20 -1.74846e-06C31.0457 -7.8281e-07 40 8.9543 40 20C40 31.0457 31.0457 40 20 40ZM16.1206 13.5198C15.7554 13.1055 15.1632 13.1055 14.798 13.5198L9.58704 19.4308C9.22182 19.8451 9.22182 20.5168 9.58704 20.931L14.798 26.8421C15.1632 27.2563 15.7554 27.2563 16.1206 26.8421C16.4858 26.4278 16.4858 25.7561 16.1206 25.3418L12.4912 21.2248L29.6865 21.2248C30.2388 21.2248 30.6865 20.7771 30.6865 20.2248C30.6865 19.6725 30.2388 19.2248 29.6865 19.2248L12.4138 19.2248L16.1206 15.02C16.4858 14.6057 16.4858 13.934 16.1206 13.5198Z" fill="var(--bs-dark)"/></svg></button>',Zt='<button class="slick-next slick-next-custom" arial-label="Next" type="button"><svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M20 3.49691e-06C31.0457 5.4282e-06 40 8.95431 40 20C40 31.0457 31.0457 40 20 40C8.9543 40 1.56562e-06 31.0457 3.49691e-06 20C5.4282e-06 8.95431 8.95431 1.56562e-06 20 3.49691e-06ZM23.8794 26.4802C24.2446 26.8945 24.8368 26.8945 25.202 26.4802L30.413 20.5692C30.7782 20.1549 30.7782 19.4833 30.413 19.069L25.202 13.1579C24.8368 12.7437 24.2446 12.7437 23.8794 13.1579C23.5142 13.5722 23.5142 14.2439 23.8794 14.6582L27.5088 18.7752L10.3135 18.7752C9.7612 18.7752 9.31348 19.2229 9.31348 19.7752C9.31348 20.3275 9.76119 20.7752 10.3135 20.7752L27.5862 20.7752L23.8794 24.98C23.5142 25.3943 23.5142 26.066 23.8794 26.4802Z" fill="var(--bs-dark)"/></svg></button>';jQuery(".slick-slider-default").slick({dots:!1,arrows:!0,infinite:!0,speed:100,slidesToShow:1,slidesToScroll:1,autoplay:!1,adaptiveHeight:!0,prevArrow:Jt,nextArrow:Zt}),jQuery(".slick-top-bar").slick({dots:!1,arrows:!1,infinite:!0,speed:100,slidesToShow:1,slidesToScroll:1,autoplay:!0,prevArrow:Jt,nextArrow:Zt,vertical:!0}),jQuery(".slick-carousel, .wp-block-group.is-style-slick-carousel > .wp-block-group__inner-container, .wp-block-gallery.is-style-slick-carousel").slick({dots:!0,arrows:!0,infinite:!1,speed:100,slidesToShow:3,slidesToScroll:1,autoplay:!1,prevArrow:Jt,nextArrow:Zt,responsive:[{breakpoint:992,settings:{slidesToShow:3,slidesToScroll:1}},{breakpoint:576,settings:{slidesToShow:2,slidesToScroll:2}},{breakpoint:480,settings:{slidesToShow:1,slidesToScroll:1}}]}),jQuery(".slick-main-categories-carousel").slick({dots:!1,arrows:!0,infinite:!0,speed:100,slidesToShow:2,slidesToScroll:1,autoplay:!0,autoplaySpeed:2e3,prevArrow:Jt,nextArrow:Zt,responsive:[{breakpoint:9999999,settings:"unslick"},{breakpoint:783,settings:{slidesToShow:1}}]}),jQuery(".slick-subcategories-carousel").slick({dots:!1,arrows:!0,infinite:!0,speed:100,slidesToShow:3,slidesToScroll:1,autoplay:!0,autoplaySpeed:2e3,prevArrow:Jt,nextArrow:Zt,responsive:[{breakpoint:992,settings:{slidesToShow:2}},{breakpoint:783,settings:{slidesToShow:1}}]}),jQuery(".slick-marcas-carousel, .wp-block-group.is-layout-flex.is-style-slick-carousel-logos, .wp-block-group.is-style-slick-carousel-logos > .wp-block-group__inner-container, .wp-block-gallery.is-style-slick-carousel-logos").slick({dots:!1,arrows:!1,infinite:!0,variableWidth:!0,speed:100,slidesToShow:4,slidesToScroll:1,autoplay:!0,prevArrow:Jt,nextArrow:Zt,responsive:[{breakpoint:992,settings:{slidesToShow:4,slidesToScroll:4}},{breakpoint:782,settings:{slidesToShow:3,slidesToScroll:3}},{breakpoint:600,settings:{slidesToShow:2,slidesToScroll:2}}]}),jQuery(".products-shortcode-carousel ul").slick({dots:!1,arrows:!0,infinite:!1,speed:100,slidesToShow:4,slidesToScroll:1,autoplay:!1,prevArrow:Jt,nextArrow:Zt,responsive:[{breakpoint:992,settings:{slidesToShow:4,slidesToScroll:4}},{breakpoint:782,settings:{slidesToShow:3,slidesToScroll:3}},{breakpoint:600,settings:{slidesToShow:2,slidesToScroll:2}}]}),jQuery("#header-promos").slick({dots:!1,infinite:!0,speed:100,slidesToShow:1,slidesToScroll:1,autoplay:!0,autoplaySpeed:4100,prevArrow:Jt,nextArrow:Zt}),e.Alert=E,e.Button=O,e.Carousel=I,e.Collapse=M,e.Dropdown=vt,e.Modal=St,e.Offcanvas=jt,e.Popover=Bt,e.Scrollspy=zt,e.Tab=qt,e.Toast=Ut,e.Tooltip=Rt}));
